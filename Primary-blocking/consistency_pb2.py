...
_SERVERREGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='primary_server', full_name='consistency.ServerRegResponse.primary_server', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='success', full_name='consistency.ServerRegResponse.success', index=1,
...
_REGSERVER_SERVER = _descriptor.ServiceDescriptor(
  name='RegServer_Server',
  full_name='consistency.RegServer_Server',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='AddReplica',
    full_name='consistency.RegServer_Server.AddReplica',
    index=0,
    containing_service=None,
    input_type=_SERVER,
    output_type=_VOID,
...
_sym_db.RegisterServiceDescriptor(_REGSERVER_SERVER)

DESCRIPTOR.services_by_name['RegServer_Server'] = _REGSERVER_SERVER
