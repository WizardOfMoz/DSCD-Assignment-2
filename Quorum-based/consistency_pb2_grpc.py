...
class Client_RegServerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetNWServerList = channel.unary_stream(
        '/consistency.Client_RegServer/GetNWServerList',
        request_serializer=consistency__pb2.Void.SerializeToString,
        response_deserializer=consistency__pb2.Server.FromString,
        )
    self.GetNRServerList = channel.unary_stream(
        '/consistency.Client_RegServer/GetNRServerList',
        request_serializer=consistency__pb2.Void.SerializeToString,
        response_deserializer=consistency__pb2.Server.FromString,
        )
...
def add_Client_RegServerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetNWServerList': grpc.unary_stream_rpc_method_handler(
          servicer.GetNWServerList,
          request_deserializer=consistency__pb2.Void.FromString,
          response_serializer=consistency__pb2.Server.SerializeToString,
      ),
      'GetNRServerList': grpc.unary_stream_rpc_method_handler(
          servicer.GetNRServerList,
          request_deserializer=consistency__pb2.Void.FromString,
          response_serializer=consistency__pb2.Server.SerializeToString,
      ),
  }
